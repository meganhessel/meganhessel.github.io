...
To investigate the impact of the Eaton and Paslisades fire on unisured communities, we will use the California's Environmental Justice data's 'E_UNINSUR' variable. First, we must *join* the EJI dataset to the fire perimeters. Then, assess the uninsured community by *plotting* the census tract data for each fire.

```{python}
# Join border data with EJI census tracks 
